...
def DSACC(result_y, result_x, labels_y, labels_x):
    res_y = result_y - labels_y
    res_x = result_x - labels_x
    acc = tf.math.sqrt(res_x * res_x + res_y*res_y)
