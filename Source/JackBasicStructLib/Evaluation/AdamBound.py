...
class AdaBoundOptimizer(optimizer.Optimizer):
    ...
    def _create_slots(self, var_list):
        ...
        if not create_new and context.in_graph_mode():
            create_new = (self._get_non_slot_variable(
                "beta1_power", graph).graph is not first_var.graph)
    ...
    def _apply_dense(self, grad, var):
        ...
        gamma_multi = math_ops.cast(self._get_non_slot_variable(
            "gamma_multi", graph=graph), var.dtype.base_dtype)
